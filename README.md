...
|-----------|-------------|:-------------:|-------------:|-----------------:
| LP5 |Natural Language Processing(Sentiment Analysis)|  [Article](https://medium.com/@qacheampong/natural-language-processing-finetuning-a-pretrained-model-for-sentiment-analysis-using-covid19-97f51f5a68f7/) | [Sentiment Analysis App with Gradio](https://huggingface.co/spaces/Queensly/SentimentAnalysisApp/)| [App built with Dockerfile](https://huggingface.co/spaces/Queensly/DockerApp/) |
